    ...
    <div class="grid gap-10 lg:grid-cols-[1.1fr_1fr_1.1fr]">
        ...
        <div class="space-y-4">
            ...
            <ul class="grid gap-2 text-sm text-white/80">
                <li><a href="{{ route('profil') }}" class="transition hover:text-white">Tentang Program Studi</a></li>
                <li><a href="{{ route('dosen') }}" class="transition hover:text-white">Profil Dosen</a></li>
                <li><a href="{{ route('staf') }}" class="transition hover:text-white">Profil Staf</a></li>
                <li><a href="{{ route('kurikulum') }}" class="transition hover:text-white">Kurikulum &amp; Akademik</a></li>
                <li><a href="{{ route('berita') }}" class="transition hover:text-white">Berita Kegiatan</a></li>
                <li><a href="{{ route('galeri') }}" class="transition hover:text-white">Galeri</a></li?
            </ul>
