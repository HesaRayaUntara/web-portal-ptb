    ...
    <div class="flex h-full flex-col gap-6 lg:h-full">
        <div class="flex items-center gap-3 rounded-card bg-white px-4 py-3 shadow-soft mt-12 lg:mt-0">
            ...
            <div>
                ...
                <p class="text-xs text-textMuted">Hai, {{ \App\Models\Admin::find(session('admin_id'))->username ?? 'Admin' }}!</p>
            </div>
        </div>
        <nav class="space-y-1 text-sm font-semibold text-textMuted">
            <a href="{{ route('admin.dashboard') }}" class="block w-full rounded-xl py-3 text-left px-4 shadow-soft transition {{ request()->routeIs('admin.dashboard') ? 'bg-primary text-white' : 'bg-white hover:bg-primary/5' }}">Dashboard</a>
            <a href="{{ route('admin.profil.index') }}" class="block w-full rounded-xl py-3 text-left px-4 shadow-soft transition {{ request()->routeIs('admin.profil.*') ? 'bg-primary text-white' : 'bg-white hover:bg-primary/5' }}">Profil Program Studi</a>
            <a href="{{ route('admin.fasilitas.index') }}" class="block w-full rounded-xl py-3 text-left px-4 shadow-soft transition {{ request()->routeIs('admin.fasilitas.*') ? 'bg-primary text-white' : 'bg-white hover:bg-primary/5' }}">Fasilitas</a>
            <a href="{{ route('admin.kurikulum.index') }}" class="block w-full rounded-xl py-3 text-left px-4 shadow-soft transition {{ request()->routeIs('admin.kurikulum.*') ? 'bg-primary text-white' : 'bg-white hover:bg-primary/5' }}">Kurikulum</a>
            <a href="{{ route('admin.dosen.index') }}" class="block w-full rounded-xl py-3 text-left px-4 shadow-soft transition {{ request()->routeIs('admin.dosen.*') ? 'bg-primary text-white' : 'bg-white hover:bg-primary/5' }}">Profil Dosen</a>
            <a href="{{ route('admin.staf.index') }}" class="block w-full rounded-xl py-3 text-left px-4 shadow-soft transition {{ request()->routeIs('admin.staf.*') ? 'bg-primary text-white' : 'bg-white hover:bg-primary/5' }}">Staf</a>
            <a href="{{ route('admin.berita.index') }}" class="block w-full rounded-xl py-3 text-left px-4 shadow-soft transition {{ request()->routeIs('admin.berita.*') ? 'bg-primary text-white' : 'bg-white hover:bg-primary/5' }}">Berita</a>
            <a href="{{ route('admin.galeri.index') }}" class="block w-full rounded-xl py-3 text-left px-4 shadow-soft transition {{ request()->routeIs('admin.galeri.*') ? 'bg-primary text-white' : 'bg-white hover:bg-primary/5' }}">Galeri</a><br>
            <form method="POST" action="{{ route('admin.logout') }}" class="mt-4 lg:mt-auto">
                @csrf
                <button type="submit"
