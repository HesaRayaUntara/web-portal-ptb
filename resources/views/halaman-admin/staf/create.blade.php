...
@section('title', 'Admin - Tambah Staf')
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-8">
            ...
            {{-- Form Tambah Staf --}}
            <form method="POST" action="{{ route('admin.staf.store') }}" enctype="multipart/form-data" class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                @csrf
