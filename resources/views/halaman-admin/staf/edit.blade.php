            ...
            <form method="POST" action="{{ route('admin.staf.update', $staf->id) }}" enctype="multipart/form-data" class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" id="nama" name="nama" value="{{ old('nama', $staf->nama) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" id="jabatan" name="jabatan" value="{{ old('jabatan', $staf->jabatan) }}" required
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                    ...
                    <div>
                        ...
                        @if($staf->foto)
                            <div class="mb-2">
                                <img src="{{ Storage::url($staf->foto) }}" alt="Current image" class="h-32 w-auto rounded-lg border border-borderSoft object-cover">
