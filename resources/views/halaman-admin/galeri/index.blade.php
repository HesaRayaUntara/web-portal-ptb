                                    ...
                                    <tr class="border-t border-borderSoft transition hover:bg-gray-50">
                                        ...
                                        <td class="px-3 py-2 sm:px-4 sm:py-3">
                                            <div class="flex items-center justify-center">
                                                <form method="POST" action="{{ route('admin.galeri.deleteKategori', $kategori) }}" 
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="kategori_galeri_id" id="kategori_galeri_id" 
                                ...
                                @foreach($kategoris as $kategori)
                                    <option value="{{ $kategori->id_kategori_galeri }}" {{ old('kategori_galeri_id') == $kategori->id_kategori_galeri ? 'selected' : '' }}>
                                        {{ $kategori->nama }}
                                    </option>
                                @endforeach
                            </select>
                                    ...
                                    <tr class="border-t border-borderSoft transition hover:bg-gray-50">
                                        ...
                                        <td class="px-3 py-2 sm:px-4 sm:py-3">
                                            <div class="flex items-center justify-center gap-2">
                                                <a href="{{ route('admin.galeri.editGaleri', $galeri) }}"
                                                ...
                                                <form method="POST" action="{{ route('admin.galeri.destroyGaleri', $galeri) }}" 
