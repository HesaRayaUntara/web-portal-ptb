...
@section('title', 'Admin - Edit Fasilitas')
            ...
            <form method="POST" action="{{ route('admin.fasilitas.update', $fasilitas) }}" enctype="multipart/form-data" class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" id="nama_fasilitas" name="nama_fasilitas" value="{{ old('nama_fasilitas', $fasilitas->nama_fasilitas) }}" required
                    ...
                    <div>
                        ...
                        @if($fasilitas->foto)
                            <div class="mb-2">
                                <img src="{{ Storage::url($fasilitas->foto) }}" alt="Current image" class="h-32 w-auto rounded-lg border border-borderSoft object-cover">
