    ...
    <div class="flex flex-col gap-8 lg:flex-row lg:items-stretch">
        ...
        <main class="flex-1 space-y-8 p-6 lg:p-10">
                ...
                <div class="relative z-10 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xl font-bold text-white">{{ \App\Models\Admin::find(session('admin_id'))->username ?? 'Admin' }}</p>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-2 gap-3 md:gap-4 lg:grid-cols-4">
                {{-- Card Dosen --}}
                <a href="{{ route('admin.dosen.index') }}" class="group relative overflow-hidden rounded-lg bg-gradient-to-br bg-orange-600 shadow-md transition-all hover:scale-[1.02] hover:shadow-lg">
                    <div class="relative p-4">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <p class="text-3xl font-bold text-white">{{ $jumlahDosen ?? \App\Models\Dosen::count() }}</p>
                ...
                {{-- Card Staf --}}
                <a href="{{ route('admin.staf.index') }}" class="group relative overflow-hidden rounded-lg bg-gradient-to-br  bg-blue-600 shadow-md transition-all hover:scale-[1.02] hover:shadow-lg">
                    <div class="relative p-4">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <p class="text-3xl font-bold text-white">{{ $jumlahStaf ?? \App\Models\Staf::count() }}</p>
                ...
                {{-- Card Berita --}}
                <a href="{{ route('admin.berita.index') }}" class="group relative overflow-hidden rounded-lg bg-gradient-to-br bg-yellow-500 shadow-md transition-all hover:scale-[1.02] hover:shadow-lg">
                    <div class="relative p-4">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <p class="text-3xl font-bold text-white">{{ $jumlahBerita ?? \App\Models\Berita::count() }}</p>
                ...
                {{-- Card Galeri --}}
                <a href="{{ route('admin.galeri.index') }}" class="group relative overflow-hidden rounded-lg bg-gradient-to-br from-green-500 to-green-600 shadow-md transition-all hover:scale-[1.02] hover:shadow-lg">
                    <div class="relative p-4">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <p class="text-3xl font-bold text-white">{{ $jumlahGaleri ?? \App\Models\Galeri::count() }}</p>
            ...
            {{-- Kelola Admin --}}
            <div class="rounded-card border border-borderSoft bg-white shadow-soft" data-admin-id="{{ session('admin_id') ?? 0 }}" data-index-url="{{ route('admin.manage.index') }}" data-update-url="{{ route('admin.manage.update', ':id') }}" data-destroy-url="{{ route('admin.manage.destroy', ':id') }}" data-csrf="{{ csrf_token() }}">
                <div class="flex items-center justify-between border-b border-borderSoft px-6 py-4">
                    ...
                    <a href="{{ route('admin.register') }}" class="rounded-lg bg-primary px-2.5 py-1 text-xs font-semibold text-white shadow-soft transition hover:bg-primaryDark">
                        + Tambah
                    </a>
                </div>
            ...
            {{-- Log Activity Table --}}
            <div class="rounded-card border border-borderSoft bg-white shadow-soft" data-log-url="{{ route('admin.log-activity') }}">
                <div class="flex items-center justify-between border-b border-borderSoft px-6 py-4">
