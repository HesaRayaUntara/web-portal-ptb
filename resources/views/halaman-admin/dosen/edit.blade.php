...
@section('title', 'Admin - Edit Dosen')
            ...
            <form method="POST" action="{{ route('admin.dosen.updateDosen', $dosen) }}" enctype="multipart/form-data" class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="url" id="gsch" name="gsch" value="{{ old('gsch', $dosen->gsch) }}"
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                    ...
                    <div>
                        ...
                        @if($dosen->foto)
                            <div class="mb-2">
                                <img src="{{ Storage::url($dosen->foto) }}" alt="Current image" class="h-32 w-auto rounded-lg border border-borderSoft object-cover">
                    ...
                    <div>
                        <label class="flex items-center gap-2">
                            <input type="checkbox" id="kepala_program_studi" name="kepala_program_studi" value="1" 
                                {{ old('kepala_program_studi', $dosen->kepala_program_studi) ? 'checked' : '' }}
                                @if($hasKepalaProdi && !$dosen->kepala_program_studi) disabled @endif
                            ...
                            @if($hasKepalaProdi && !$dosen->kepala_program_studi)
