...
@section('title', 'Admin - Tambah HKI/Paten')
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row lg:items-stretch">
        ...
        <main class="flex-1 p-6 lg:p-8">
            ...
            {{-- Form Tambah HKI --}}
            <form method="POST" action="{{ route('admin.dosen.storeHki') }}" class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                @csrf
