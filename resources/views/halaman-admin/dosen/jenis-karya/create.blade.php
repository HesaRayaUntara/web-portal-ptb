...
@section('title', 'Admin - Tambah Jenis Karya')
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-8">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-textDark">Tambah Jenis Karya</h1>
                <p class="mt-1 text-sm text-textMuted">Tambahkan jenis karya baru</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.dosen.storeJenisKarya') }}" class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                @csrf
                
                <div class="space-y-6">
                    <div>
                        <label for="j_karya" class="mb-2 block text-sm font-semibold text-textDark">Jenis Karya <span class="text-red-500">*</span></label>
                        <input type="text" id="j_karya" name="j_karya" value="{{ old('j_karya') }}" required
