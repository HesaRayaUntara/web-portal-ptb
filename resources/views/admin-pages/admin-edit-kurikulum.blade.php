            ...
            <form method="POST" action="{{ route('admin.kurikulum.update', $kurikulum->id) }}" class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="kode_mata_kuliah" name="kode_mata_kuliah" value="{{ old('kode_mata_kuliah', $kurikulum->kode_mata_kuliah) }}" required
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_mata_kuliah" name="nama_mata_kuliah" value="{{ old('nama_mata_kuliah', $kurikulum->nama_mata_kuliah) }}" required
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                    ...
                    <div>
                        ...
                        <input type="text" id="status_mata_kuliah" name="status_mata_kuliah" value="{{ old('status_mata_kuliah', $kurikulum->status_mata_kuliah) }}" required
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
