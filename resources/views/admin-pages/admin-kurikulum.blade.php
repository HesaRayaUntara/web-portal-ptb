                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea id="deskripsi_semester_1_2" name="deskripsi_semester_1_2" rows="4"
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15">{{ old('deskripsi_semester_1_2', $deskripsiKurikulum->deskripsi_semester_1_2 ?? '') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi_semester_3_4" name="deskripsi_semester_3_4" rows="4"
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15">{{ old('deskripsi_semester_3_4', $deskripsiKurikulum->deskripsi_semester_3_4 ?? '') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi_semester_5_6" name="deskripsi_semester_5_6" rows="4"
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15">{{ old('deskripsi_semester_5_6', $deskripsiKurikulum->deskripsi_semester_5_6 ?? '') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi_semester_7_8" name="deskripsi_semester_7_8" rows="4"
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15">{{ old('deskripsi_semester_7_8', $deskripsiKurikulum->deskripsi_semester_7_8 ?? '') }}</textarea>
                    </div>
                </div>
                                ...
                                @foreach($kurikulumBySemester as $semester => $kurikulumItems)
                                    @foreach($kurikulumItems as $index => $item)
                                        <tr class="border-b border-borderSoft transition hover:bg-[#F4F7F3]">
                                            @if($index === 0)
                                                <td class="px-4 py-4 text-sm font-semibold text-textDark" rowspan="{{ $kurikulumItems->count() }}">Semester {{ $semester }}</td>
                                            @endif
                                            ...
                                            <td class="px-4 py-2">
                                                <div class="flex items-center justify-center gap-2">
                                                    ...
                                                    <form method="POST" action="{{ route('admin.kurikulum.destroy', $item->id) }}" class="inline"
