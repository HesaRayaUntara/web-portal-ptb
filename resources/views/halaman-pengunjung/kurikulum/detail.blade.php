...
<section class="mt-6 space-y-6 md:mt-8 md:space-y-8">
    ...
    <section class="rounded-section bg-white p-4 shadow-soft md:p-6 lg:p-8">
            ...
            <table class="min-w-full table-auto text-left text-xs text-textDark md:text-sm">
                        ...
                        <td class="whitespace-nowrap px-3 py-2 md:px-4 md:py-3">{{ $index + 1 }}</td>
                        <td class="whitespace-nowrap px-3 py-2 md:px-4 md:py-3">{{ $item->kode_mk }}</td>
                        <td class="whitespace-nowrap px-3 py-2 md:px-4 md:py-3">{{ $item->nama_mk }}</td>
                        <td class="whitespace-nowrap px-3 py-2 md:px-4 md:py-3">{{ $item->jenis_mk }}</td>
                        <td class="whitespace-nowrap px-3 py-2 md:px-4 md:py-3">{{ $item->sks_kuliah + $item->sks_praktikum }} ({{ $item->sks_kuliah }}-{{ $item->sks_praktikum }})</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
