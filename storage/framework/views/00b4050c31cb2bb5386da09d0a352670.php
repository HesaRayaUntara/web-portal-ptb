                                ...
                                <?php $__currentLoopData = $kurikulumBySemester; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester => $kurikulumItems): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php $__currentLoopData = $kurikulumItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr class="transition <?php echo e($isLastItem && !$isLastSemester ? 'border-b border-borderSoft' : ''); ?>">
                                            <?php if($index === 0): ?>
                                                <td class="px-4 py-2 text-xs text-textMuted align-center" rowspan="<?php echo e($kurikulumItems->count()); ?>">Semester <?php echo e($semester); ?></td>
                                            <?php endif; ?>
                                            ...
                                            <td class="px-4 py-2">
                                                <div class="flex items-center justify-center gap-2">
                                                    <a href="<?php echo e(route('admin.kurikulum.edit', $item)); ?>"
                                                    ...
                                                    <form method="POST" action="<?php echo e(route('admin.kurikulum.destroy', $item)); ?>" class="inline flex-shrink-0"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/kurikulum/index.blade.php ENDPATH**/ ?>