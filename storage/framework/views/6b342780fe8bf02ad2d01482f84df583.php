    ...
    <div class="grid grid-cols-2 gap-2.5 md:gap-3">
        ...
        <div class="group relative overflow-hidden rounded-card bg-white p-4 shadow-card">
            ...
            <div class="relative">
                ...
                <h3 class="mt-1.5 text-xl font-bold text-secondary md:text-2xl"><?php echo e($profilProdi->lama_studi); ?></h3>
        ...
        <div class="group relative overflow-hidden rounded-card bg-white p-4 shadow-card">
            ...
            <div class="relative">
                ...
                <h3 class="mt-1.5 text-xl font-bold text-secondary md:text-2xl"><?php echo e($profilProdi->gelar_lulusan); ?></h3>
                <?php if($profilProdi->kepanjangan_gelar): ?>
                <p class="mt-0.5 text-[10px] font-semibold text-textMuted md:text-xs"><?php echo e($profilProdi->kepanjangan_gelar); ?></p>
                <?php endif; ?>
            </div>
        </div>
        <?php endif; ?>
