...
<?php $__env->startSection('title', 'Admin - Edit Fasilitas'); ?>
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        <aside class="w-full border-borderSoft bg-[#F4F7F3] p-6 lg:w-80 lg:border-r">
            <div class="flex flex-col gap-6">
                ...
                <nav class="space-y-1 text-sm font-semibold text-textMuted">
                    ...
                    <a href="<?php echo e(route('admin.fasilitas.index')); ?>" class="block w-full rounded-xl bg-primary py-3 text-left px-4 text-white shadow-soft">Fasilitas</a>
        ...
        <main class="flex-1 p-6 lg:p-8">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-textDark">Edit Fasilitas</h1>
                <p class="mt-1 text-sm text-textMuted">Edit data fasilitas</p>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('admin.fasilitas.update', $fasilitas->id)); ?>" enctype="multipart/form-data" class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                
                <div class="space-y-6">
                    <div>
                        <label for="nama_fasilitas" class="mb-2 block text-sm font-semibold text-textDark">Nama Fasilitas</label>
                        <input type="text" id="nama_fasilitas" name="nama_fasilitas" value="<?php echo e(old('nama_fasilitas', $fasilitas->nama_fasilitas)); ?>" required
                            ...
                            placeholder="Contoh: Laboratorium Inovasi">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="4" required
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                            placeholder="Masukkan deskripsi fasilitas"><?php echo e(old('deskripsi', $fasilitas->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <?php if($fasilitas->foto): ?>
                            <div class="mb-2">
                                <img src="<?php echo e(Storage::url($fasilitas->foto)); ?>" alt="Current image" class="h-32 w-auto rounded-lg border border-borderSoft object-cover">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/admin-pages/admin-edit-fasilitas.blade.php ENDPATH**/ ?>