...
<?php $__env->startSection('title', 'Admin - Fasilitas'); ?>
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-8">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-textDark">Fasilitas</h1>
                <p class="mt-1 text-sm text-textMuted">Kelola fasilitas program studi</p>
            </div>
            ...
            <div class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="text-lg font-semibold text-textDark">Daftar Fasilitas</h2>
                    <a href="<?php echo e(route('admin.fasilitas.tambah')); ?>"
                                ...
                                <?php $__currentLoopData = $fasilitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b border-borderSoft transition hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <?php if($item->foto): ?>
                                                <img src="<?php echo e(Storage::url($item->foto)); ?>" alt="<?php echo e($item->nama_fasilitas); ?>" class="h-16 w-16 rounded-lg object-cover">
                                            <?php else: ?>
                                                <div class="flex h-16 w-16 items-center justify-center rounded-lg bg-gray-200 text-xs text-gray-400">No Image</div>
                                            <?php endif; ?>
                                        </td>
                                        <td class="px-4 py-3 text-sm font-semibold text-textDark whitespace-nowrap"><?php echo e($item->nama_fasilitas); ?></td>
                                        <td class="px-4 py-3 text-sm text-textMuted"><?php echo e(Str::limit($item->deskripsi, 100)); ?></td>
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="flex items-center justify-center gap-2">
                                                <a href="<?php echo e(route('admin.fasilitas.edit', $item->id)); ?>"
                                                ...
                                                <form method="POST" action="<?php echo e(route('admin.fasilitas.destroy', $item->id)); ?>" class="inline flex-shrink-0"
                ...
                <?php else: ?>
                    <div class="py-8 text-center">
                        <p class="text-sm text-textMuted">Belum ada fasilitas yang ditambahkan.</p>
                    </div>
                <?php endif; ?>
            </div>
        </main>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/admin-pages/admin-fasilitas.blade.php ENDPATH**/ ?>