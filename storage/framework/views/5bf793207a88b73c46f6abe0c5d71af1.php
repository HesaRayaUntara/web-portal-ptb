            ...
            <table class="min-w-full table-auto text-left text-xs text-textDark md:text-sm">
                ...
                <tbody class="divide-y divide-primary/10">
                    ...
                    <tr class="hover:bg-accent/60">
                        <td class="px-3 py-2 md:px-4 md:py-3"><?php echo e($index + 1); ?></td>
                        <td class="px-3 py-2 md:px-4 md:py-3"><?php echo e($item->kode_mk); ?></td>
                        <td class="px-3 py-2 md:px-4 md:py-3"><?php echo e($item->nama_mk); ?></td>
                        <td class="px-3 py-2 md:px-4 md:py-3"><?php echo e($item->jenis_mk); ?></td>
                        <td class="px-3 py-2 md:px-4 md:py-3"><?php echo e($item->sks_kuliah + $item->sks_praktikum); ?> (<?php echo e($item->sks_kuliah); ?>-<?php echo e($item->sks_praktikum); ?>)</td>
                    </tr>
