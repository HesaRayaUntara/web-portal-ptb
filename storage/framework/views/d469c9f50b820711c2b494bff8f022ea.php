...
<?php $__env->startSection('title', 'Admin - Edit Profil Lulusan'); ?>
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-8">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-textDark">Edit Profil Lulusan</h1>
                <p class="mt-1 text-sm text-textMuted">Edit profil lulusan</p>
            </div>
            ...
            <?php if(isset($profilLulusan) && $profilLulusan): ?>
            <form method="POST" action="<?php echo e(route('admin.profil-lulusan.update', $profilLulusan)); ?>" class="space-y-8">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="peran" name="peran" required
                                ...
                                placeholder="cth. Peneliti Pemuliaan Tanaman" value="<?php echo e(old('peran', $profilLulusan->peran)); ?>">
                        </div>
                        <div>
                            ...
                            <textarea id="deskripsi_kemampuan" name="deskripsi_kemampuan" rows="5" required
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark placeholder:text-textMuted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                placeholder="Masukkan deskripsi kemampuan"><?php echo e(old('deskripsi_kemampuan', $profilLulusan->deskripsi_kemampuan)); ?></textarea>
                        </div>
                    </div>
                </section>
            ...
            <?php else: ?>
                <div class="rounded-xl border border-red-300 bg-red-50 px-4 py-3 text-sm text-red-800">
                    Profil Lulusan tidak ditemukan.
                </div>
            <?php endif; ?>
        </main>
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/profil-lulusan/edit.blade.php ENDPATH**/ ?>