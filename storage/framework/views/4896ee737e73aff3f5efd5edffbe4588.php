<?php $__env->startSection('title', 'Admin - Edit Dosen'); ?>
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-8">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-textDark">Edit Dosen</h1>
                <p class="mt-1 text-sm text-textMuted">Edit data dosen</p>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('admin.dosen.updateDosen', $dosen)); ?>" enctype="multipart/form-data" class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" id="nama" name="nama" value="<?php echo e(old('nama', $dosen->nama)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="status" name="status" required
                            ...
                            <option value="dosen tetap" <?php echo e(old('status', $dosen->status) == 'dosen tetap' ? 'selected' : ''); ?>>Dosen Tetap</option>
                            <option value="dosen tidak tetap" <?php echo e(old('status', $dosen->status) == 'dosen tidak tetap' ? 'selected' : ''); ?>>Dosen Tidak Tetap</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea id="bidang_keahlian" name="bidang_keahlian" rows="4"
                            ...
                            placeholder="Setiap poin dipisahkan dengan baris baru"><?php echo e(old('bidang_keahlian', $dosen->bidang_keahlian)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="<?php echo e(old('email', $dosen->email)); ?>"
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="url" id="gsch" name="gsch" value="<?php echo e(old('gsch', $dosen->gsch)); ?>"
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                            placeholder="Contoh: https://scholar.google.com/citations?user=...">
                        <?php $__errorArgs = ['gsch'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <?php if($dosen->foto): ?>
                            <div class="mb-2">
                                <img src="<?php echo e(Storage::url($dosen->foto)); ?>" alt="Current image" class="h-32 w-auto rounded-lg border border-borderSoft object-cover">
                    ...
                    <div>
                        <label class="flex items-center gap-2">
                            <input type="checkbox" id="kepala_program_studi" name="kepala_program_studi" value="1" 
                                <?php echo e(old('kepala_program_studi', $dosen->kepala_program_studi) ? 'checked' : ''); ?>

                                <?php if($hasKepalaProdi && !$dosen->kepala_program_studi): ?> disabled <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/dosen/edit.blade.php ENDPATH**/ ?>