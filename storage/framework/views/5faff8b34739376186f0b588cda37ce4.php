<?php $__env->startSection('title', 'Detail Dosen - ' . $dosen->nama); ?>
...
?>
    ...
    <nav class="mb-6 flex items-center gap-2 text-sm text-textMuted">
        ...
        <span> > </span>
        <span class="text-primaryDark"><?php echo e($dosen->nama); ?></span>
    </nav>
                ...
                <div class="space-y-4 text-center md:text-left">
                            ...
                            <?php $__currentLoopData = explode("\n", $dosen->bidang_keahlian); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bidang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(trim($bidang)): ?>
                                    <p class="flex items-start gap-2 pl-6 text-xs text-textMuted md:text-sm">
                                        ...
                                        <span><?php echo e(trim($bidang)); ?></span>
                                    </p>
                                <?php endif; ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <ul class="space-y-1.5 pl-6 text-xs text-textMuted md:text-sm">
                            <?php if($dosen->pendidikan): ?>
                                <?php $__currentLoopData = explode("\n", $dosen->pendidikan); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pendidikan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(trim($pendidikan)): ?>
                                        <li class="flex items-start gap-2">
                                            <span class="flex-shrink-0 text-primary">•</span>
                                            <span><?php echo e(trim($pendidikan)); ?></span>
                                        </li>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center gap-3">
                            <?php if($dosen->email): ?>
                                <a href="mailto:<?php echo e($dosen->email); ?>" class="flex items-center justify-center rounded-full bg-primary/10 p-2 text-primary transition-all duration-200 hover:bg-primary/20 hover:scale-105">
                            ...
                            <?php endif; ?>
                            <?php if($dosen->gsch): ?>
                                <a href="<?php echo e($dosen->gsch); ?>" target="_blank" class="flex items-center justify-center rounded-full bg-primary/10 p-2 text-primary transition-all duration-200 hover:bg-primary/20 hover:scale-105">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-pengunjung/dosen/detail.blade.php ENDPATH**/ ?>