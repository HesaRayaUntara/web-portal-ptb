...
<?php $__env->startSection('title', 'Admin - Edit Publikasi Karya'); ?>
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-8">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-textDark">Edit Publikasi Karya</h1>
                <p class="mt-1 text-sm text-textMuted">Edit publikasi karya</p>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('admin.dosen.updatePublikasi', $publikasi)); ?>" class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <select id="dosen_id" name="dosen_id"
                            ...
                            <?php $__currentLoopData = $dosen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($d->id_dosen); ?>" <?php echo e(old('dosen_id', $publikasi->dosen_id) == $d->id_dosen ? 'selected' : ''); ?>><?php echo e($d->nama); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label for="judul_karya" class="mb-2 block text-sm font-semibold text-textDark">Judul Karya <span class="text-red-500">*</span></label>
                        <input type="text" id="judul_karya" name="judul_karya" value="<?php echo e(old('judul_karya', $publikasi->judul_karya)); ?>" required
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                            placeholder="Contoh: Genetic Diversity Analysis of Rice Varieties">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label for="jenis_karya" class="mb-2 block text-sm font-semibold text-textDark">Jenis Karya <span class="text-red-500">*</span></label>
                        <select id="jenis_karya" name="jenis_karya" required
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15">
                            ...
                            <?php $__currentLoopData = $jenisKarya; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($jk->j_karya); ?>" <?php echo e(old('jenis_karya', $publikasi->jenis_karya) == $jk->j_karya ? 'selected' : ''); ?>><?php echo e($jk->j_karya); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['jenis_karya'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" id="tahun" name="tahun" value="<?php echo e(old('tahun', $publikasi->tahun)); ?>" required min="1900" max="<?php echo e(date('Y')); ?>"
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/dosen/publikasi/edit.blade.php ENDPATH**/ ?>