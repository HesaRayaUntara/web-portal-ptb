    ...
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-8">
            ...
            <form method="POST" action="<?php echo e(route('admin.kurikulum.updateDeskripsi')); ?>" class="mb-8 rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                <?php echo csrf_field(); ?>
                <h2 class="mb-4 text-lg font-semibold text-textDark">Deskripsi Kurikulum</h2>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea id="deskripsi_semester_1_2" name="deskripsi_semester_1_2" rows="4"
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"><?php echo e(old('deskripsi_semester_1_2', $deskripsiKurikulum->deskripsi_semester_1_2 ?? '')); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi_semester_3_4" name="deskripsi_semester_3_4" rows="4"
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"><?php echo e(old('deskripsi_semester_3_4', $deskripsiKurikulum->deskripsi_semester_3_4 ?? '')); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi_semester_5_6" name="deskripsi_semester_5_6" rows="4"
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"><?php echo e(old('deskripsi_semester_5_6', $deskripsiKurikulum->deskripsi_semester_5_6 ?? '')); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi_semester_7_8" name="deskripsi_semester_7_8" rows="4"
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"><?php echo e(old('deskripsi_semester_7_8', $deskripsiKurikulum->deskripsi_semester_7_8 ?? '')); ?></textarea>
                    </div>
                </div>
            ...
            <div class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('admin.kurikulum.create')); ?>"
                        class="rounded-lg bg-primary px-3 py-1.5 text-xs font-semibold text-white shadow-soft transition hover:bg-primaryDark">
                        + Tambah
                    </a>
                </div>
                ...
                <?php if($kurikulumBySemester->count() > 0): ?>
                    <div class="overflow-x-auto">
                        <table class="table-fixed border-collapse whitespace-nowrap min-w-max w-full">
                            <thead>
                                <tr class="border-b border-borderSoft bg-[#F4F7F3]">
                                    ...
                                    <th class="px-4 py-3 text-center text-sm font-semibold text-textDark">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $__currentLoopData = $kurikulumBySemester; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester => $kurikulumItems): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $__currentLoopData = $kurikulumItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="border-b border-borderSoft transition hover:bg-[#F4F7F3]">
                                            <?php if($index === 0): ?>
                                                <td class="px-4 py-4 text-sm font-semibold text-textDark" rowspan="<?php echo e($kurikulumItems->count()); ?>">Semester <?php echo e($semester); ?></td>
                                            <?php endif; ?>
                                            <td class="px-4 py-2 text-sm text-textMuted">
                                            ...
                                            <td class="px-4 py-2">
                                                <div class="flex items-center justify-center gap-2">
                                                    <a href="<?php echo e(route('admin.kurikulum.edit', $item->id)); ?>"
                                                        class="flex items-center justify-center rounded-lg bg-blue-50 p-2 text-blue-600 transition hover:bg-blue-100"
                                                        title="Edit">
                                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                        </svg>
                                                    </a>
                                                    <form method="POST" action="<?php echo e(route('admin.kurikulum.destroy', $item->id)); ?>" class="inline"
