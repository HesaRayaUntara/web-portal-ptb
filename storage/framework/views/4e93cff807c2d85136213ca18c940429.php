        ...
        <main class="flex-1 p-4 md:p-6 lg:p-8">
            ...
            <form method="POST" action="<?php echo e(route('admin.galeri.updateGaleri', $galeri)); ?>" enctype="multipart/form-data" id="galeriForm" class="rounded-xl border border-borderSoft bg-white p-4 shadow-soft sm:p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div id="photo-input" class="<?php echo e(old('tipe', $galeri->tipe) == 'photo' ? 'block' : 'hidden'); ?>">
                    ...
                    <div id="video-input" class="<?php echo e(old('tipe', $galeri->tipe) == 'video' ? 'block' : 'hidden'); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/galeri/edit.blade.php ENDPATH**/ ?>