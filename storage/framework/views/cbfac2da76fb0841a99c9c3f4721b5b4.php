...
<?php $__env->startSection('title', 'Admin - Tambah Profil Lulusan'); ?>
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-8">
            ...
            <form method="POST" action="<?php echo e(route('admin.profil-lulusan.store')); ?>" class="space-y-8">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="peran" name="peran" required
                                ...
                                placeholder="cth. Peneliti Pemuliaan Tanaman" value="<?php echo e(old('peran')); ?>">
                        </div>
                        <div>
                            ...
                            <textarea id="deskripsi_kemampuan" name="deskripsi_kemampuan" rows="5" required
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark placeholder:text-textMuted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                placeholder="Masukkan deskripsi kemampuan"><?php echo e(old('deskripsi_kemampuan')); ?></textarea>
                        </div>
                    </div>
                </section>
                ...
                <div class="flex justify-end gap-4">
                    <a href="<?php echo e(route('admin.profil-lulusan.index')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/profil-lulusan/create.blade.php ENDPATH**/ ?>