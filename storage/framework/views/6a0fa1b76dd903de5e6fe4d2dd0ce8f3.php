                                    ...
                                    <tr class="border-b border-borderSoft transition hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="flex items-center justify-center gap-2">
                                                <button data-edit-dosen="<?php echo e($item->id); ?>" class="flex items-center justify-center rounded-lg bg-blue-50 p-2 text-blue-600 transition hover:bg-blue-100" title="Edit">
                                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                    </svg>
                                                </button>
                                                <button data-delete-dosen="<?php echo e($item->id); ?>" class="flex items-center justify-center rounded-lg bg-red-50 p-2 text-red-600 transition hover:bg-red-100" title="Hapus">
                                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <table class="w-full border-collapse">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $jenisKarya; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b border-borderSoft transition hover:bg-gray-50">
                                        <td class="px-4 py-3 text-sm text-textMuted whitespace-nowrap"><?php echo e($index + 1); ?></td>
                                        <td class="px-4 py-3 text-sm text-textDark"><?php echo e($item->j_karya); ?></td>
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="flex items-center justify-center gap-2">
                                                <button data-edit-jenis-karya="<?php echo e($item->id); ?>" class="flex items-center justify-center rounded-lg bg-blue-50 p-2 text-blue-600 transition hover:bg-blue-100" title="Edit">
                                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                    </svg>
                                                </button>
                                                <button data-delete-jenis-karya="<?php echo e($item->id); ?>" class="flex items-center justify-center rounded-lg bg-red-50 p-2 text-red-600 transition hover:bg-red-100" title="Hapus">
                                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                                    </svg>
                                                </button>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $penelitian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b border-borderSoft transition hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="flex items-center justify-center gap-2">
                                                <button data-edit-penelitian="<?php echo e($item->id); ?>" class="flex items-center justify-center rounded-lg bg-blue-50 p-2 text-blue-600 transition hover:bg-blue-100" title="Edit">
                                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                    </svg>
                                                </button>
                                                <button data-delete-penelitian="<?php echo e($item->id); ?>" class="flex items-center justify-center rounded-lg bg-red-50 p-2 text-red-600 transition hover:bg-red-100" title="Hapus">
                                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                                    </svg>
                                                </button>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $pengabdian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b border-borderSoft transition hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="flex items-center justify-center gap-2">
                                                <button data-edit-pengabdian="<?php echo e($item->id); ?>" class="flex items-center justify-center rounded-lg bg-blue-50 p-2 text-blue-600 transition hover:bg-blue-100" title="Edit">
                                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                    </svg>
                                                </button>
                                                <button data-delete-pengabdian="<?php echo e($item->id); ?>" class="flex items-center justify-center rounded-lg bg-red-50 p-2 text-red-600 transition hover:bg-red-100" title="Hapus">
                                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                                    </svg>
                                                </button>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $publikasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b border-borderSoft transition hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="flex items-center justify-center gap-2">
                                                <button data-edit-publikasi="<?php echo e($item->id); ?>" class="flex items-center justify-center rounded-lg bg-blue-50 p-2 text-blue-600 transition hover:bg-blue-100" title="Edit">
                                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                    </svg>
                                                </button>
                                                <button data-delete-publikasi="<?php echo e($item->id); ?>" class="flex items-center justify-center rounded-lg bg-red-50 p-2 text-red-600 transition hover:bg-red-100" title="Hapus">
                                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                                    </svg>
                                                </button>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $hki; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b border-borderSoft transition hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="flex items-center justify-center gap-2">
                                                <button data-edit-hki="<?php echo e($item->id); ?>" class="flex items-center justify-center rounded-lg bg-blue-50 p-2 text-blue-600 transition hover:bg-blue-100" title="Edit">
                                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                    </svg>
                                                </button>
                                                <button data-delete-hki="<?php echo e($item->id); ?>" class="flex items-center justify-center rounded-lg bg-red-50 p-2 text-red-600 transition hover:bg-red-100" title="Hapus">
                                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                                    </svg>
                                                </button>
                ...
                <div>
                    <label class="flex items-center gap-2">
                        <input type="checkbox" id="dosen-kepala-prodi" name="kepala_program_studi" value="1" 
                            <?php if($hasKepalaProdi): ?> disabled <?php endif; ?>
        ...
        <form id="form-penelitian">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="number" id="penelitian-tahun" name="tahun" required min="1900" max="<?php echo e(date('Y')); ?>" class="w-full rounded-lg border border-borderSoft px-3 py-2 text-sm focus:border-primary focus:outline-none">
                </div>
            </div>
            <div class="mt-6 flex justify-end gap-3">
    ...
    <div class="mx-4 w-full max-w-md rounded-xl bg-white p-6 shadow-soft">
        ...
        <form id="form-pengabdian">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label class="mb-1 block text-sm font-semibold text-textDark">Tahun <span class="text-red-500">*</span></label>
                    <input type="number" id="pengabdian-tahun" name="tahun" required min="1900" max="<?php echo e(date('Y')); ?>" class="w-full rounded-lg border border-borderSoft px-3 py-2 text-sm focus:border-primary focus:outline-none">
                </div>
            </div>
            <div class="mt-6 flex justify-end gap-3">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select id="publikasi-jenis" name="jenis_karya" required class="w-full rounded-lg border border-borderSoft px-3 py-2 text-sm focus:border-primary focus:outline-none">
                        ...
                        <?php $__currentLoopData = $jenisKarya; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($jk->j_karya); ?>"><?php echo e($jk->j_karya); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    <label class="mb-1 block text-sm font-semibold text-textDark">Tahun <span class="text-red-500">*</span></label>
                    <input type="number" id="publikasi-tahun" name="tahun" required min="1900" max="<?php echo e(date('Y')); ?>" class="w-full rounded-lg border border-borderSoft px-3 py-2 text-sm focus:border-primary focus:outline-none">
                </div>
            </div>
            <div class="mt-6 flex justify-end gap-3">
    ...
    <div class="mx-4 w-full max-w-md rounded-xl bg-white p-6 shadow-soft">
        ...
        <form id="form-hki">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label class="mb-1 block text-sm font-semibold text-textDark">Tahun <span class="text-red-500">*</span></label>
                    <input type="number" id="hki-tahun" name="tahun" required min="1900" max="<?php echo e(date('Y')); ?>" class="w-full rounded-lg border border-borderSoft px-3 py-2 text-sm focus:border-primary focus:outline-none">
                </div>
            </div>
            <div class="mt-6 flex justify-end gap-3">
...
{
    "dosen": <?php echo json_encode($dosen, 15, 512) ?>,
    "hasKepalaProdi": <?php echo json_encode($hasKepalaProdi, 15, 512) ?>,
    "jenisKarya": <?php echo json_encode($jenisKarya, 15, 512) ?>,
    "penelitian": <?php echo json_encode($penelitian, 15, 512) ?>,
    "pengabdian": <?php echo json_encode($pengabdian, 15, 512) ?>,
    "publikasi": <?php echo json_encode($publikasi, 15, 512) ?>,
    "hki": <?php echo json_encode($hki, 15, 512) ?>
}
</script>
<script>
    ...
    document.getElementById('form-dosen').addEventListener('submit', async function(e) {
        ...
        const url = id 
            ? '<?php echo e(route("admin.dosen.updateDosen", ":id")); ?>'.replace(':id', id)
            : '<?php echo e(route("admin.dosen.storeDosen")); ?>';
    ...
    async function deleteDosen(id) {
        ...
        try {
            const response = await fetch('<?php echo e(route("admin.dosen.destroyDosen", ":id")); ?>'.replace(':id', id), {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                }
    ...
    document.getElementById('form-jenis-karya').addEventListener('submit', async function(e) {
        ...
        const url = id 
            ? '<?php echo e(route("admin.dosen.updateJenisKarya", ":id")); ?>'.replace(':id', id)
            : '<?php echo e(route("admin.dosen.storeJenisKarya")); ?>';
        const method = id ? 'PUT' : 'POST';
    ...
    async function deleteJenisKarya(id) {
        ...
        try {
            const response = await fetch('<?php echo e(route("admin.dosen.destroyJenisKarya", ":id")); ?>'.replace(':id', id), {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                }
    ...
    document.getElementById('form-penelitian').addEventListener('submit', async function(e) {
        ...
        const url = id 
            ? '<?php echo e(route("admin.dosen.updatePenelitian", ":id")); ?>'.replace(':id', id)
            : '<?php echo e(route("admin.dosen.storePenelitian")); ?>';
        const method = id ? 'PUT' : 'POST';
    ...
    async function deletePenelitian(id) {
        ...
        try {
            const response = await fetch('<?php echo e(route("admin.dosen.destroyPenelitian", ":id")); ?>'.replace(':id', id), {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                }
    ...
    document.getElementById('form-pengabdian').addEventListener('submit', async function(e) {
        ...
        const url = id 
            ? '<?php echo e(route("admin.dosen.updatePengabdian", ":id")); ?>'.replace(':id', id)
            : '<?php echo e(route("admin.dosen.storePengabdian")); ?>';
        const method = id ? 'PUT' : 'POST';
    ...
    async function deletePengabdian(id) {
        ...
        try {
            const response = await fetch('<?php echo e(route("admin.dosen.destroyPengabdian", ":id")); ?>'.replace(':id', id), {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                }
    ...
    document.getElementById('form-publikasi').addEventListener('submit', async function(e) {
        ...
        const url = id 
            ? '<?php echo e(route("admin.dosen.updatePublikasi", ":id")); ?>'.replace(':id', id)
            : '<?php echo e(route("admin.dosen.storePublikasi")); ?>';
        const method = id ? 'PUT' : 'POST';
    ...
    async function deletePublikasi(id) {
        ...
        try {
            const response = await fetch('<?php echo e(route("admin.dosen.destroyPublikasi", ":id")); ?>'.replace(':id', id), {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                }
    ...
    document.getElementById('form-hki').addEventListener('submit', async function(e) {
        ...
        const url = id 
            ? '<?php echo e(route("admin.dosen.updateHki", ":id")); ?>'.replace(':id', id)
            : '<?php echo e(route("admin.dosen.storeHki")); ?>';
        const method = id ? 'PUT' : 'POST';
    ...
    async function deleteHki(id) {
        ...
        try {
            const response = await fetch('<?php echo e(route("admin.dosen.destroyHki", ":id")); ?>'.replace(':id', id), {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                }
