...
<?php $__env->startSection('title', 'Admin - Tambah HKI/Paten'); ?>
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-8">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-textDark">Tambah HKI/Paten</h1>
                <p class="mt-1 text-sm text-textMuted">Tambahkan HKI/Paten baru</p>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('admin.dosen.storeHki')); ?>" class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/dosen/hki/create.blade.php ENDPATH**/ ?>