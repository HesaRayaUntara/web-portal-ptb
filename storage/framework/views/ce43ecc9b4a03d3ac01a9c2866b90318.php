                                    ...
                                    <tr class="border-t border-borderSoft transition hover:bg-gray-50">
                                        ...
                                        <td class="px-3 py-2 sm:px-4 sm:py-3">
                                            <div class="flex items-center justify-center">
                                                <form method="POST" action="<?php echo e(route('admin.galeri.deleteKategori', $kategori->id)); ?>" 
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="kategori_galeri_id" id="kategori_galeri_id" 
                                ...
                                <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kategori->id); ?>" <?php echo e(old('kategori_galeri_id') == $kategori->id ? 'selected' : ''); ?>>
                                    ...
                                    <tr class="border-t border-borderSoft transition hover:bg-gray-50">
                                        ...
                                        <td class="px-3 py-2 sm:px-4 sm:py-3">
                                            <div class="flex items-center justify-center gap-2">
                                                <a href="<?php echo e(route('admin.galeri.editGaleri', $galeri->id)); ?>"
                                                ...
                                                <form method="POST" action="<?php echo e(route('admin.galeri.destroyGaleri', $galeri->id)); ?>" 
