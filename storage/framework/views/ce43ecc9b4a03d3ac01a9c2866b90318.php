<?php $__env->startSection('title', 'Admin - Galeri'); ?>
    ...
    <div class="flex flex-col gap-8 lg:flex-row lg:items-stretch">
        ...
        <main class="flex-1 p-4 md:p-6 lg:p-8">
            ...
            <div class="mb-6 rounded-xl border border-borderSoft bg-white p-4 shadow-soft sm:mb-8 sm:p-6">
                ...
                <form method="POST" action="<?php echo e(route('admin.galeri.storeKategori')); ?>" class="mb-6">
                    <?php echo csrf_field(); ?>
                                    ...
                                    <tr class="border-t border-borderSoft transition hover:bg-gray-50">
                                        ...
                                        <td class="px-3 py-2 sm:px-4 sm:py-3">
                                            <div class="flex items-center justify-center">
                                                <form method="POST" action="<?php echo e(route('admin.galeri.deleteKategori', $kategori)); ?>" 
            ...
            <div class="mb-6 rounded-xl border border-borderSoft bg-white p-4 shadow-soft sm:mb-8 sm:p-6">
                ...
                <form method="POST" action="<?php echo e(route('admin.galeri.storeGaleri')); ?>" enctype="multipart/form-data" id="galeriForm">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-4">
                        <div>
                        ...
                        <div>
                            ...
                            <select name="kategori_galeri_id" id="kategori_galeri_id" 
                                ...
                                <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kategori->id_kategori_galeri); ?>" <?php echo e(old('kategori_galeri_id') == $kategori->id_kategori_galeri ? 'selected' : ''); ?>>
                        ...
                        <div>
                            ...
                            <select name="tipe" id="tipe" 
                                ...
                                <option value="photo" <?php echo e(old('tipe') == 'photo' ? 'selected' : ''); ?>>Foto</option>
                        ...
                        <div id="video-input" style="display: none;">
                            ...
                            <input type="url" name="youtube_url" id="youtube_url" value="<?php echo e(old('youtube_url')); ?>" 
                                class="w-full rounded-lg border border-borderSoft px-3 py-2 text-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 sm:px-4" 
                ...
                <?php if($galeriList->count() > 0): ?>
                    <div class="overflow-x-auto -mx-4 sm:mx-0">
                        <table class="w-full min-w-[500px] border-collapse">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $galeriList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $galeri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-t border-borderSoft transition hover:bg-gray-50">
                                        <td class="px-3 py-2 text-xs text-textMuted sm:px-4 sm:py-3 sm:text-sm"><?php echo e($galeri->judul); ?></td>
                                        <td class="px-3 py-2 text-center sm:px-4 sm:py-3">
                                            <span class="inline-block rounded-full px-2 py-1 text-xs font-semibold <?php echo e($galeri->tipe === 'photo' ? 'bg-blue-100 text-blue-700' : 'bg-red-100 text-red-700'); ?>">
                                                <?php echo e($galeri->tipe === 'photo' ? 'Foto' : 'Video'); ?>

                                            </span>
                                        </td>
                                        <td class="px-3 py-2 sm:px-4 sm:py-3">
                                            <div class="flex items-center justify-center gap-2">
                                                <a href="<?php echo e(route('admin.galeri.editGaleri', $galeri)); ?>"
                                                ...
                                                <form method="POST" action="<?php echo e(route('admin.galeri.destroyGaleri', $galeri)); ?>" 
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const oldTipeValue = '<?php echo e(old("tipe", "")); ?>';
        if (oldTipeValue) {
            toggleInputs();
        }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/galeri/index.blade.php ENDPATH**/ ?>