...
<?php $__env->startSection('title', 'Admin - Tambah Fasilitas'); ?>
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-8">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-textDark">Tambah Fasilitas</h1>
                <p class="mt-1 text-sm text-textMuted">Tambahkan fasilitas baru</p>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('admin.fasilitas.store')); ?>" enctype="multipart/form-data" class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                <?php echo csrf_field(); ?>
                
                <div class="space-y-6">
                    <div>
                        <label for="nama_fasilitas" class="mb-2 block text-sm font-semibold text-textDark">Nama Fasilitas</label>
                        <input type="text" id="nama_fasilitas" name="nama_fasilitas" value="<?php echo e(old('nama_fasilitas')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="4" required
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                            placeholder="Masukkan deskripsi fasilitas"><?php echo e(old('deskripsi')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/admin-pages/admin-tambah-fasilitas.blade.php ENDPATH**/ ?>