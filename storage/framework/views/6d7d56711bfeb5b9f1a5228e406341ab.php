...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="kode_mk" name="kode_mk" value="<?php echo e(old('kode_mk')); ?>" required
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_mk" name="nama_mk" value="<?php echo e(old('nama_mk')); ?>" required
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="jenis_mk" name="jenis_mk" required
                            ...
                            <option value="CCC" <?php echo e(old('jenis_mk') == 'CCC' ? 'selected' : ''); ?>>CCC: Common Core Courses</option>
                            <option value="FC" <?php echo e(old('jenis_mk') == 'FC' ? 'selected' : ''); ?>>FC: Foundational Courses</option>
                            <option value="FL" <?php echo e(old('jenis_mk') == 'FL' ? 'selected' : ''); ?>>FL: Foundational Literacies Courses</option>
                            <option value="IC" <?php echo e(old('jenis_mk') == 'IC' ? 'selected' : ''); ?>>IC: In-depth Study Program Courses</option>
                            <option value="ACC" <?php echo e(old('jenis_mk') == 'ACC' ? 'selected' : ''); ?>>ACC: Vocational Core Courses</option>
                            <option value="EC" <?php echo e(old('jenis_mk') == 'EC' ? 'selected' : ''); ?>>EC: Enrichment Courses</option>
                            <option value="FYP" <?php echo e(old('jenis_mk') == 'FYP' ? 'selected' : ''); ?>>FYP: Final Year Project</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <input type="number" id="sks_kuliah" name="sks_kuliah" value="<?php echo e(old('sks_kuliah')); ?>" min="0"
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                placeholder="0">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" id="sks_praktikum" name="sks_praktikum" value="<?php echo e(old('sks_praktikum')); ?>" min="0"
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                placeholder="0">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/kurikulum/create.blade.php ENDPATH**/ ?>