...
<?php $__env->startSection('title', 'Admin - Edit Mitra'); ?>
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-8">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-textDark">Edit Mitra</h1>
                <p class="mt-1 text-sm text-textMuted">Edit mitra</p>
            </div>
            ...
            <?php if(isset($mitra) && $mitra): ?>
            <form method="POST" action="<?php echo e(route('admin.mitra.update', $mitra)); ?>" enctype="multipart/form-data" class="space-y-8">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="nama_mitra" name="nama_mitra" required
                                ...
                                placeholder="Masukkan nama mitra" value="<?php echo e(old('nama_mitra', $mitra->nama_mitra)); ?>">
                        </div>
                        <div>
                            <label for="logo" class="mb-2 block text-sm font-semibold text-textDark">Logo</label>
                            <?php if($mitra->logo): ?>
                                <div class="mb-2">
                                    <img src="<?php echo e(Storage::url($mitra->logo)); ?>" alt="Logo Mitra" class="h-16 w-auto rounded-lg border border-borderSoft object-cover">
                                </div>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/mitra/edit.blade.php ENDPATH**/ ?>