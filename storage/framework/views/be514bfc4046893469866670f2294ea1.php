    ...
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-4 md:p-6 lg:p-8">
            ...
            <?php if($berita->status === 'draft'): ?>
                <form method="POST" action="<?php echo e(route('admin.berita.updateDraft', $berita->id)); ?>" enctype="multipart/form-data" class="rounded-xl border border-borderSoft bg-white p-4 shadow-soft sm:p-6">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
            <?php else: ?>
                <form method="POST" action="<?php echo e(route('admin.berita.updateBerita', $berita->id)); ?>" enctype="multipart/form-data" class="rounded-xl border border-borderSoft bg-white p-4 shadow-soft sm:p-6">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
            <?php endif; ?>
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="kategori_berita_id" id="kategori_berita_id" 
                            ...
                            <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($kategori->id); ?>" <?php echo e(old('kategori_berita_id', $berita->kategori_berita_id) == $kategori->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/admin-pages/admin-edit-berita.blade.php ENDPATH**/ ?>