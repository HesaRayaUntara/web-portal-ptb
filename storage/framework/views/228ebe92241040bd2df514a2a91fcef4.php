    ...
    <div id="mobile-menu" class="hidden w-full flex-col gap-4 md:hidden">
        <nav class="w-full">
            <ul class="flex flex-col gap-3 text-15 font-medium text-textDark/90">
                <li>
                    <a href="<?php echo e(route('beranda')); ?>" class="block transition-colors hover:text-primary <?php echo e(request()->routeIs('beranda') ? 'text-primary font-semibold' : ''); ?>">Beranda</a>
                </li>
                <li>
                    <button type="button" id="mobile-profil-toggle" class="flex w-full items-center justify-between transition-colors hover:text-primary <?php echo e(request()->routeIs('profil') || request()->routeIs('dosen') || request()->routeIs('staf') ? 'text-primary font-semibold' : ''); ?>">
                        <span>Profil</span>
                    ...
                    <ul id="mobile-profil-dropdown" class="mt-2 ml-4 hidden flex-col gap-2 border-l-2 border-primary/20 pl-4">
                        <li>
                    <a href="<?php echo e(route('profil')); ?>" class="block transition-colors hover:text-primary <?php echo e(request()->routeIs('profil') ? 'text-primary font-semibold' : ''); ?>">Program Studi</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('dosen')); ?>" class="block transition-colors hover:text-primary <?php echo e(request()->routeIs('dosen') ? 'text-primary font-semibold' : ''); ?>">Dosen</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('staf')); ?>" class="block transition-colors hover:text-primary <?php echo e(request()->routeIs('staf') ? 'text-primary font-semibold' : ''); ?>">Staf</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="<?php echo e(route('kurikulum')); ?>" class="block transition-colors hover:text-primary <?php echo e(request()->routeIs('kurikulum') ? 'text-primary font-semibold' : ''); ?>">Kurikulum</a>
                </li>
                <li>
                    <a href="<?php echo e(route('berita')); ?>" class="block transition-colors hover:text-primary <?php echo e(request()->routeIs('berita') ? 'text-primary font-semibold' : ''); ?>">Berita</a>
                </li>
                <li>
                    <a href="<?php echo e(route('galeri')); ?>" class="block transition-colors hover:text-primary <?php echo e(request()->routeIs('galeri') ? 'text-primary font-semibold' : ''); ?>">Galeri</a>
                </li>
            </ul>
        </nav>
    ...
    <nav class="hidden w-full md:block md:w-auto">
        <ul class="flex flex-wrap gap-x-6 gap-y-3 text-15 font-medium text-textDark/90">
            ...
            <li class="relative group">
                <a href="#" class="flex items-center gap-1 transition-colors hover:text-primary <?php echo e(request()->routeIs('profil') || request()->routeIs('dosen') || request()->routeIs('staf') ? 'text-primary font-semibold' : ''); ?>">
                    Profil
                ...
                <div class="absolute left-0 top-full z-50 pt-2">
                    <div class="hidden min-w-[180px] flex-col rounded-lg border border-primary/10 bg-white text-sm text-textDark shadow-soft group-hover:flex">
                        <a href="<?php echo e(route('profil')); ?>" class="flex items-center gap-3 rounded-t-lg px-4 py-2 transition hover:bg-primary/10 hover:text-primary <?php echo e(request()->routeIs('profil') ? 'bg-primary/10 text-primary font-semibold' : ''); ?>">
                            <span>Program Studi</span>
                        </a>
                        <a href="<?php echo e(route('dosen')); ?>" class="flex items-center gap-3 px-4 py-2 transition hover:bg-primary/10 hover:text-primary <?php echo e(request()->routeIs('dosen') ? 'bg-primary/10 text-primary font-semibold' : ''); ?>">
                            <span>Dosen</span>
                        </a>
                        <a href="<?php echo e(route('staf')); ?>" class="flex items-center gap-3 rounded-b-lg px-4 py-2 transition hover:bg-primary/10 hover:text-primary <?php echo e(request()->routeIs('staf') ? 'bg-primary/10 text-primary font-semibold' : ''); ?>">
                            <span>Staf</span>
                        </a>
                    </div>
                </div>
