...
<?php $__env->startSection('title', 'Admin - Tambah Profil Program Studi'); ?>
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-8">
            ...
            <form method="POST" action="<?php echo e(route('admin.profil.store')); ?>" enctype="multipart/form-data" class="space-y-8">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="tujuan" name="tujuan" rows="5" required
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark placeholder:text-textMuted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                placeholder="Masukkan tujuan program studi (pisahkan dengan baris baru)"><?php echo e(old('tujuan')); ?></textarea>
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        <div>
                            ...
                            <input type="text" id="lama_studi" name="lama_studi" required
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark placeholder:text-textMuted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                placeholder="cth. 8" value="<?php echo e(old('lama_studi')); ?>">
                        </div>
                        <div>
                            ...
                            <input type="text" id="gelar_lulusan" name="gelar_lulusan" required
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark placeholder:text-textMuted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                placeholder="cth. S.Kom." value="<?php echo e(old('gelar_lulusan')); ?>">
                        </div>
                        <div>
                            ...
                            <input type="text" id="kepanjangan_gelar" name="kepanjangan_gelar" required
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark placeholder:text-textMuted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                placeholder="cth. Sarjana Komputer" value="<?php echo e(old('kepanjangan_gelar')); ?>">
                        </div>
                    </div>
                </section>
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        <div>
                            ...
                            <input type="number" id="snbp_pelamar" name="snbp_pelamar" min="0" required
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark placeholder:text-textMuted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                placeholder="0" value="<?php echo e(old('snbp_pelamar')); ?>" oninput="calculateKeketatan('snbp')">
                        </div>
                        <div>
                            ...
                            <input type="number" id="snbp_diterima" name="snbp_diterima" min="1" required
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark placeholder:text-textMuted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                placeholder="0" value="<?php echo e(old('snbp_diterima')); ?>" oninput="calculateKeketatan('snbp')">
                        </div>
                        <div>
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        <div>
                            ...
                            <input type="number" id="snbt_pelamar" name="snbt_pelamar" min="0" required
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark placeholder:text-textMuted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                placeholder="0" value="<?php echo e(old('snbt_pelamar')); ?>" oninput="calculateKeketatan('snbt')">
                        </div>
                        <div>
                            ...
                            <input type="number" id="snbt_diterima" name="snbt_diterima" min="1" required
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark placeholder:text-textMuted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                placeholder="0" value="<?php echo e(old('snbt_diterima')); ?>" oninput="calculateKeketatan('snbt')">
                        </div>
                        <div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="akreditasi" name="akreditasi" required
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark placeholder:text-textMuted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                value="<?php echo e(old('akreditasi')); ?>">
                        </div>
                        <div>
                            ...
                            <input type="text" id="no_sk" name="no_sk" required
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark placeholder:text-textMuted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                placeholder="" value="<?php echo e(old('no_sk')); ?>">
                        </div>
                        <div>
                ...
                <section class="rounded-card border border-borderSoft bg-white p-6 shadow-soft">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="file" id="mitra_logo" name="mitra_logo[]" accept="image/jpeg,image/jpg,image/png" multiple required
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15">
                ...
                <section class="rounded-card border border-borderSoft bg-white p-6 shadow-soft">
                    ...
                    <div id="profil-lulusan-container" class="space-y-4" data-initial-count="0">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/profil/create.blade.php ENDPATH**/ ?>