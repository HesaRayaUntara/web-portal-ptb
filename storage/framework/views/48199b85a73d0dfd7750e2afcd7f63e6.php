        ...
        <div class="mx-auto flex w-full max-w-3xl flex-col overflow-hidden rounded-xl bg-white shadow-md lg:flex-row lg:shadow-lg">
            ...
            <div class="flex w-full items-center justify-center p-5 sm:p-6 lg:w-3/5 lg:p-8">
                <div class="w-full max-w-xs space-y-5">
                    ...
                    <!-- Login Form -->
                    <form class="space-y-3.5" method="POST" action="<?php echo e(route('admin.login.submit')); ?>" id="loginForm">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/admin-login.blade.php ENDPATH**/ ?>