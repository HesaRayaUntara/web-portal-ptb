...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="judul_penelitian" name="judul_penelitian" value="<?php echo e(old('judul_penelitian', $penelitian->judul_penelitian)); ?>" required
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" id="tahun" name="tahun" value="<?php echo e(old('tahun', $penelitian->tahun)); ?>" required min="1900" max="<?php echo e(date('Y')); ?>"
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/dosen/penelitian/edit.blade.php ENDPATH**/ ?>