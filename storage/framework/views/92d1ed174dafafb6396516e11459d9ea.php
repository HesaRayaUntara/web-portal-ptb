...
<?php $__env->startSection('title', 'Admin - Tambah Staf'); ?>
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-8">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-textDark">Tambah Staf</h1>
                <p class="mt-1 text-sm text-textMuted">Tambahkan staf baru</p>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('admin.staf.store')); ?>" enctype="multipart/form-data" class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="jabatan" name="jabatan" value="<?php echo e(old('jabatan')); ?>" required
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
...
unset($__errorArgs, $__bag); ?>
                        <div id="image-preview" class="mt-3 hidden">
                            <img id="preview-img" src="" alt="Preview" class="h-32 w-32 rounded-full border-2 border-primary object-cover">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/admin-pages/admin-tambah-staf.blade.php ENDPATH**/ ?>