...
<?php $__env->startSection('title', 'Admin - Tambah Mitra'); ?>
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-8">
            ...
            <form method="POST" action="<?php echo e(route('admin.mitra.store')); ?>" enctype="multipart/form-data" class="space-y-8">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="nama_mitra" name="nama_mitra" required
                                ...
                                placeholder="Masukkan nama mitra" value="<?php echo e(old('nama_mitra')); ?>">
                        </div>
                        <div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/mitra/create.blade.php ENDPATH**/ ?>