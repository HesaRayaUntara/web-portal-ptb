...
<?php $__env->startSection('content'); ?>
        ...
        <div class="space-y-4">
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <div class="group rounded-lg border border-primary/10 bg-white/60 p-4 transition-all duration-200 hover:border-primary/20 hover:bg-white md:p-5">
                    ...
                    <p class="text-xs leading-relaxed text-textMuted md:text-sm"><?php echo e($deskripsiKurikulum->deskripsi_semester_1_2); ?></p>
                </div>
                <div class="group rounded-lg border border-primary/10 bg-white/60 p-4 transition-all duration-200 hover:border-primary/20 hover:bg-white md:p-5">
                    <h3 class="mb-2 text-sm font-semibold text-textDark md:text-base">Semester 3-4</h3>
                    <p class="text-xs leading-relaxed text-textMuted md:text-sm"><?php echo e($deskripsiKurikulum->deskripsi_semester_3_4); ?></p>
                </div>
                <div class="group rounded-lg border border-primary/10 bg-white/60 p-4 transition-all duration-200 hover:border-primary/20 hover:bg-white md:p-5">
                    <h3 class="mb-2 text-sm font-semibold text-textDark md:text-base">Semester 5-6</h3>
                    <p class="text-xs leading-relaxed text-textMuted md:text-sm"><?php echo e($deskripsiKurikulum->deskripsi_semester_5_6); ?></p>
                </div>
                <div class="group rounded-lg border border-primary/10 bg-white/60 p-4 transition-all duration-200 hover:border-primary/20 hover:bg-white md:p-5">
                    <h3 class="mb-2 text-sm font-semibold text-textDark md:text-base">Semester 7-8</h3>
                    <p class="text-xs leading-relaxed text-textMuted md:text-sm"><?php echo e($deskripsiKurikulum->deskripsi_semester_7_8); ?></p>
                </div>
            </div>
    ...
    <script>
        function downloadPDF() {
            window.location.href = '<?php echo e(route("kurikulum.download")); ?>';
        }
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-pengunjung/kurikulum/index.blade.php ENDPATH**/ ?>