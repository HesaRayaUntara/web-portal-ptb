...
<?php $__env->startSection('title', 'Admin - Tambah Dosen'); ?>
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-8">
            ...
            <form method="POST" action="<?php echo e(route('admin.dosen.storeDosen')); ?>" enctype="multipart/form-data" class="rounded-xl border border-borderSoft bg-white p-6 shadow-soft">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="status" name="status" required
                            ...
                            <option value="dosen tetap" <?php echo e(old('status') == 'dosen tetap' ? 'selected' : ''); ?>>Dosen Tetap</option>
                            <option value="dosen tidak tetap" <?php echo e(old('status') == 'dosen tidak tetap' ? 'selected' : ''); ?>>Dosen Tidak Tetap</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="url" id="gsch" name="gsch" value="<?php echo e(old('gsch')); ?>"
                            class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                    ...
                    <div>
                        <label class="flex items-center gap-2">
                            <input type="checkbox" id="kepala_program_studi" name="kepala_program_studi" value="1" 
                                <?php echo e(old('kepala_program_studi') ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/dosen/create.blade.php ENDPATH**/ ?>