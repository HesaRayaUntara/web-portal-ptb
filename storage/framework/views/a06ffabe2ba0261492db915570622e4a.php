                            ...
                            <tbody>
                                <?php $__currentLoopData = $fasilitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b border-borderSoft transition hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3  text-sm text-textMuted "><?php echo e($item->nama_fasilitas); ?></td>
                                        <td class="px-4 py-3 text-sm text-textMuted"><?php echo e(Str::limit($item->deskripsi, 100)); ?></td>
                                        <td class="px-4 py-3 ">
                                            <div class="flex items-center justify-center gap-2">
                                                <a href="<?php echo e(route('admin.fasilitas.edit', $item)); ?>"
                                                ...
                                                <form method="POST" action="<?php echo e(route('admin.fasilitas.destroy', $item)); ?>" class="inline flex-shrink-0"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/fasilitas/index.blade.php ENDPATH**/ ?>