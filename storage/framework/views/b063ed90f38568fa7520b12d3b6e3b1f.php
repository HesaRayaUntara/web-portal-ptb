<?php $__env->startSection('title', 'Admin - Edit Berita'); ?>
...
<div class="rounded-section border border-borderSoft bg-white shadow-soft">
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <main class="flex-1 p-4 md:p-6 lg:p-8">
            <div class="mb-6">
                <h1 class="text-xl font-bold text-textDark sm:text-2xl"><?php echo e($berita->status === 'draft' ? 'Edit Draft Berita' : 'Edit Berita'); ?></h1>
                <p class="mt-1 text-xs text-textMuted sm:text-sm"><?php echo e($berita->status === 'draft' ? 'Edit berita yang masih dalam status draft' : 'Edit berita yang sudah dipublikasikan'); ?></p>
            </div>
            ...
            <?php if($berita->status === 'draft'): ?>
                <form method="POST" action="<?php echo e(route('admin.berita.updateDraft', $berita)); ?>" enctype="multipart/form-data" class="rounded-xl border border-borderSoft bg-white p-4 shadow-soft sm:p-6">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
            <?php else: ?>
                <form method="POST" action="<?php echo e(route('admin.berita.updateBerita', $berita)); ?>" enctype="multipart/form-data" class="rounded-xl border border-borderSoft bg-white p-4 shadow-soft sm:p-6">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
            <?php endif; ?>
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="kategori_berita_id" id="kategori_berita_id" 
                            ...
                            <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($kategori->id_kategori_berita); ?>" <?php echo e(old('kategori_berita_id', $berita->kategori_berita_id) == $kategori->id_kategori_berita ? 'selected' : ''); ?>>
                    ...
                    <div>
                        ...
                        <input type="text" name="penulis" id="penulis" value="<?php echo e(old('penulis', $berita->penulis)); ?>" 
                            class="w-full rounded-lg border border-borderSoft px-3 py-2 text-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 sm:px-4" 
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <?php if($berita->image): ?>
                            <div class="mb-2">
                                <img src="<?php echo e(Storage::url($berita->image)); ?>" alt="Current image" class="h-24 w-auto rounded-lg border border-borderSoft object-cover sm:h-32">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/berita/edit.blade.php ENDPATH**/ ?>