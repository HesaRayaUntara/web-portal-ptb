                                    ...
                                    <tr class="border-t border-borderSoft transition hover:bg-gray-50">
                                        ...
                                        <td class="px-3 py-2 sm:px-4 sm:py-3">
                                            <div class="flex items-center justify-center gap-2">
                                                <a href="<?php echo e(route('admin.berita.editDraft', $draft)); ?>"
                                                ...
                                                <form method="POST" action="<?php echo e(route('admin.berita.destroyBerita', $draft)); ?>" 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/halaman-admin/berita/draft.blade.php ENDPATH**/ ?>