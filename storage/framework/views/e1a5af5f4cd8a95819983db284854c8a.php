                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <select id="semester" name="semester" required
                            ...
                            <?php for($i = 1; $i <= 8; $i++): ?>
                                <option value="<?php echo e($i); ?>" <?php echo e(old('semester', $kurikulum->semester) == $i ? 'selected' : ''); ?>>Semester <?php echo e($i); ?></option>
                            <?php endfor; ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <input type="number" id="sks_kuliah" name="sks_kuliah" value="<?php echo e(old('sks_kuliah', $kurikulum->sks_kuliah)); ?>" required min="0"
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                placeholder="0">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" id="sks_praktikum" name="sks_praktikum" value="<?php echo e(old('sks_praktikum', $kurikulum->sks_praktikum)); ?>" required min="0"
                                class="w-full rounded-xl border border-borderSoft px-4 py-3 text-sm text-textDark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/15"
                                placeholder="0">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-portal-ptb\resources\views/admin-pages/admin-edit-kurikulum.blade.php ENDPATH**/ ?>